            ...
            <div class="col-lg-8">
              ...
              <div class="blog-post blog-md clearfix">
                ...
                <div class="ttr-post-info">
                  <ul class="media-post">
                    <li><a href="<?php echo base_url()?>panduan/panduan_read/<?php echo $key->slug_title;?>"><i class="fa fa-calendar"></i><?php echo date("d F Y", strtotime($key->create_ad));?></a></li>
                    <li><a href="#"><i class="fa fa-user"></i>ICE Institute</a></li>
                  </ul>
                  <h5 class="post-title"><a href="<?php echo base_url()?>panduan/panduan_read/<?php echo $key->slug_title;?>"><?php echo $key->title;?>.</a></h5>
                  <p><?php echo $key->meta;?></p>
                  <div class="post-extra">
                    <a href="<?php echo base_url()?>panduan/panduan_read/<?php echo $key->slug_title;?>" class="btn-link">Baca Selengkapnya</a>
